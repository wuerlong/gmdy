...
$sql .=	" order by a.orderlist desc,a.id desc";
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<form method="get" action="article.php" style="margin: 0"><input
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
			...
			<tr>
				...
				<td align="right"><select name="select"
					onChange="window.location.href='article.php?id='+this.value">
					<option value="0">--所有栏目--</option>
              <?php getCategorySelect ($id)?>
                    </select> <input type="button" value="添加文章"
					onClick="location.href='article.add.php?act=add&cid=<?php echo $id;?>'"
					class="submit"></td>
			</tr>
		</table>
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
