...
$article = $db->find ( "select * from phpaadb_res where id=" . $id );
?>
<html>
<head>
...
<body onLoad="document.getElementById('title').focus()">
    <form action="article1.action.php" method="post" enctype="multipart/form-data" name="form1">
