...
$allid=getArealChildIds($id);
	
if($allid){$cid=$id.",".$allid;}
if (!empty($id)) {
...
$sql .=	" order by a.pubdate desc,a.id desc";
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<form method="get" action="article1.php" style="margin: 0"><input
			type="hidden" name="cid" value="<?php echo $id;?>">
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
			class="serach">
			<tr>
				<td width="70" height="40" align="right">关键搜索：  </td>
				<td width="135" style="padding-left: 2px"><input title="输入文章标题或文章内容"
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
			...
			<tr>
				...
				<td align="right"><select name="select"
					onChange="window.location.href='article1.php?id='+this.value">
					<option value="0">--所有栏目--</option>
              <?php getArealSelect ($id)?>
                    </select> <input type="button" value="添加文章"
					onClick="location.href='article1.add.php?act=add&cid=<?php echo $id;?>'"
					class="submit"></td>
			</tr>
		</table>
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
        ...
        <tr onMouseOver="this.className='relow'"
				...
				<td height="26"><a
					href="article1.add.php?act=edit&id=<?php echo $al ['id'];?>&cid=<?php echo $al ['cid'];?>"> <?php echo $al ['title'];?> </a>&nbsp;</td>
				<td height="26" align="center"><?php echo $al ['pubdate'];?> &nbsp;</td>
				<td align="center"><?php echo $al ['orderlist'];?> &nbsp;</td>
				<td align="center"><?php echo $al ['cname'];?> &nbsp;</td>
				<td height="26" align="center"><a
					href="article1.add.php?act=edit&cid=<?php echo $al['cid'];?>&id=<?php echo $al ['id'];?>"><img
