...
$sql = "select a.*,b.name as cname,c.username 
		from phpaadb_rest a 
		left outer join phpaadb_area2 b on a.cid=b.id
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
			...
			<tr>
				...
				<td align="right"><select name="select"
					onChange="window.location.href='article2.php?id='+this.value">
					<option value="0">--所有栏目--</option>
              <?php getArea2Select ($id)?>
                    </select> <input type="button" value="添加文章"
					onClick="location.href='article2.add.php?act=add&cid=<?php echo $id;?>'"
					class="submit"></td>
			</tr>
		</table>
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
        ...
        <tr onMouseOver="this.className='relow'"
				...
				<td height="26"><a
					href="article2.add.php?act=edit&id=<?php echo $al ['id'];?>&cid=<?php echo $al ['cid'];?>"> <?php echo $al ['title'];?> </a>&nbsp;</td>
				...
				<td height="26" align="center"><a
					href="article2.add.php?act=edit&cid=<?php echo $al['cid'];?>&id=<?php echo $al ['id'];?>"><img
