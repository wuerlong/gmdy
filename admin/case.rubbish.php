...
$sql_string = "select a.*,b.name as cname,c.username from phpaadb_case a 
...
$mpurl 	= "case.rubbish.php?id=" . $id."&keywords=".$keywords;
$article_list = $db->selectLimit ( $sql_string, $page_size, ($page - 1) * $page_size );
//========================


$name = $db->getOneField ( "select name from phpaadb_case_category where id =" . $id );
?>
<html>
<head>
