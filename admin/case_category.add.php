...
$seq=0;
if($act=='edit'){
	$classify_row = $db->find("select * from phpaadb_case_category where id=".$id);
...
<body>
<form action="case_category.action.php" method="post">
...
<table width="100%" border="0" align="center" cellpadding="0"
	...
	<tr class="row" style="display:none;">
      ...
      <?php getCaseCategorySelect($pid)?>
      </select>      </td>
    </tr>
	<tr class="row">
		<td align="right" class="form_list">活动名称：</td>
	  <td height="26" class="form_list"><input name="name" type="text"
			value="<?php echo $name;?>" style="width: 250px"></td>
	</tr>
    <tr class="row">
		<td align="right" class="form_list">活动描述：</td>
	  <td height="26" class="form_list"><textarea name="description" class="form" style="width:400px; height: 120px; overflow: auto"><?php echo trim ( $description );?></textarea></td>
	</tr>
	<tr class="row">
