...
<table width="100%" border="0" cellpadding="0" cellspacing="0" >
  <tr>
    <td valign="top" style="padding:10px;"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_head">
          <tr>
            <td width="39%" height="31">新品上市栏目管理</td>
            <td width="61%" align="right"></td>
            <td width="61%" align="right"><input type="button" value="添加栏目"
			onClick="location.href='category_pro.add.php?act=add'" class="submit1"></td>
          </tr>
        </table>
...
function getCategoryList($id = 0, $level = 0) {
	global $db;
	$category_arr = $db->findAll ( "SELECT * FROM phpaadb_category WHERE pid = " . $id . " order by seq,id" );
...
<tr onMouseOver=\"this.className='relow'\" onMouseOut=\"this.className='row'\" class=\"row\">
	...
	<td height=\"26\" align=\"center\">
		<a href='article.add.php?act=add&cid=" . $id . "'>添加文章</a> |&nbsp;
		<a href='category_pro.add.php?act=edit&id=" . $id . "'>修改栏目</a> |&nbsp;
