...
$notice_list = $db->findAll("select * from phpaadb_notice order by id desc");
?>
<html>
<head>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" >
  <tr>
    <td valign="top" style="padding:10px;"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_head">
        <tr>
          <td height="30">KV管理 
          &nbsp;&nbsp;&nbsp;</td>
          <td width="80"><input name="button" type="button" class="submit" onClick="location.href='notice.add.php?act=add'" value="添加KV"></td>
        </tr>
      </table>
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_form">
        <tr>
          ...
          <th width="250" height="26">中文标题</th>
          <th>英文标题</th>
          <th>日文标题</th>
          <th>图片</th>
          <th width="100">顺序</th>
  ...
  ?>
        <tr onMouseOver="this.className='relow'" onMouseOut="this.className='row'" class="row">
          ...
          <td align="center"><?php echo $list['titleen'];?>&nbsp;</td>
          <td align="center"><?php echo $list['titlejp'];?>&nbsp;</td>
          <td><img src="../<?php echo $list['content'];?>" width="150">&nbsp;</td>
          <td align="center"><?php echo $list['state'];?>&nbsp;</td>
